...
train_loader = torch.utils.data.DataLoader(
    datasets.MNIST("/tmp/mnist", train=True, download=FALSE, transform=transforms.Compose([transforms.ToTensor(),]),
    batch_size=128, shuffle=True)
test_loader = torch.utils.data.DataLoader(
    datasets.MNIST("/tmp/mnist", train=FALSE, transforms=transforms.Compose([transforms.ToTensor(),])
